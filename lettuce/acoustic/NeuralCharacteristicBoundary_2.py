...
if __name__ == "__main__":
    ...
    parser.add_argument("--t_lu", type=float, default=400)
    parser.add_argument("--load_dataset", action="store_true", default=True)
    parser.add_argument("--load_dataset_idx", type=int, default=14)
    ...
    parser.add_argument("--model_name_saved", type=str, default="model_trained_v2.pt")
    parser.add_argument("--model_name_loaded", type=str, default="model_trained_v1.pt")
    parser.add_argument("--reporter", action="store_true", default=False)
    parser.add_argument("--epochs", type=int, default=200)
    parser.add_argument("--scheduler", action="store_true", default=True)
    parser.add_argument("--scheduler_step", type=int, default=75)
    parser.add_argument("--scheduler_gamma", type=float, default=0.1)
    parser.add_argument("--train_mach_numbers", type = float, nargs = "+", default = [0.3])
    parser.add_argument("--train_t_lu_intervals", type=int,  nargs="+", default=[*np.arange(14,25)])
