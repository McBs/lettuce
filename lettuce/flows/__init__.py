...
from lettuce.flows.taylorgreen import TaylorGreenVortex2D, TaylorGreenVortex3D, TaylorGreenVortex2D_semi3D
...
flow_by_name = {
    ...
    "forced": [ForcedTurbulence, D3Q19],
    "basic": [BasicFlow, D2Q9]
}
